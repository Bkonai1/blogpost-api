...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend Course by Bhaskar",
				"This project is developed by Bhaskar", "1.0", "Terms & Service",
				new Contact("Bhaskar", "https://github.com/Bkonai1", "konaibhaskar@gmail.com"),
